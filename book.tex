...
A\emph{assignment} $\sigma$ maps each formula to $\texttt{True}$ or $\texttt{False}$.
...
\begin{problem}\label{problem:short-questions}
    ...
    \begin{enumerate}
        \item Can a formula satisfiable but not valid?  If yes, provide an example of such a formula over $p,q$.
        \item Can a formula valid but not satisfiable? If yes, provide an example of such a formula over $p,q$.
